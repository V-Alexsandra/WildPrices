            ...
            <Row>
              <Card body className="basketcard">
                <Container>
                  <Row>
                    <Col sm={4} md={6} lg={8}>
                      <a href={product.link} target="_blank" rel="noopener noreferrer" className="name">
                        {product.name}
                      </a>
                    </Col>
                    <Col>
                      ...
                      <img
                        ...
                        height="21"
                        className=""
                        onClick={() => handleShowModal(product.article)}
                      ></img>
                    </Col>
                  </Row>
                </Container>
                ...
                <Container>
                  <Row>
                    ...
                    <Col>
                      <p className="text">
                        Текущая стоимость: <b>{formatPrice(product.currentPrice)} руб.</b>
                      </p>
                    </Col>
                  </Row>
                  <Row>
                    ...
                    <Col>
                      <p className="text">
                        Желаемая стоимость: <b>{formatPrice(product.desiredPrice)} руб.</b>
                      </p>
                    </Col>
                  </Row>
                </Container>
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title style={{ fontFamily: 'Franklin Gothic Book, sans-serif', fontSize: '16px', color: '#150056' }}>
            Вы действительно хотите удалить отслеживаемый товар?
          </Modal.Title>
        </Modal.Header>
        <Modal.Footer>
          <Button
        ...
        <Row>
          <Col>
            <NavDropdown title="Фильтр" id="nav-dropdown" className="navdropdown" onSelect={handleDropdownSelect}>
              <NavDropdown.Item className="navdropdown" eventKey="4.1">
                Все товары
              </NavDropdown.Item>
              <NavDropdown.Item id="dots-costs" onClick={handleClickDostigle} className="navdropdown" eventKey="4.2">
                Достигшие желаемой стоимости
              </NavDropdown.Item>
              <NavDropdown.Item className="navdropdown" eventKey="4.3">
                Не достигшие желаемой стоимости
              </NavDropdown.Item>
            </NavDropdown>
